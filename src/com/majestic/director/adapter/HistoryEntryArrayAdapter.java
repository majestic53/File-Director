/**
 * 	File Director -- HistoryEntryArrayAdapter.java
 *
 *      Author: David Jolly 
...
public class HistoryEntryArrayAdapter extends ArrayAdapter<Entry> {
	...
	/**
	 * HistoryEntryArrayAdapter constructor
	 * @param context Context
	 * @param viewId Integer
	 * @param entries List<Entry>
	 */
	public HistoryEntryArrayAdapter(Context context, int viewId, List<Entry> entries) {
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		fileName.setText(entry.getFile().getAbsolutePath());
